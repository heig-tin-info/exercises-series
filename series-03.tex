...
\begin{parts}
  \part \CD{printf("\%d\n", 42);}  \hfill \fillin[\CD{42}][5cm]
  \part \CD{printf("u\% 5d\n", 42);}  \hfill \fillin[\CD{u   42}][5cm]
  \part \CD{printf("\%05d\n", 42);}  \hfill \fillin[\CD{00042}][5cm]
  \part \CD{printf("\%-5d<", 42);}  \hfill \fillin[\CD{42   <}][5cm]
  \part \CD{printf("\%-05d\n", i);}  \hfill \fillin[\CD{42000}][5cm]
  \part \CD{printf("\%0*d\n", 10, i);}  \hfill \fillin[\CD{0000000042}][5cm]
  \part \CD{printf("\%.1f\n", 3.1415);}  \hfill \fillin[\CD{3.1}][5cm]
  \part \CD{printf("\%05.1f\n", 3.1415);}  \hfill \fillin[\CD{003.1}][5cm]
  \part \CD{printf("\%d\%d\%d\n", 42, 23, 42);}  \hfill \fillin[\CD{422342}][5cm]
  \part \CD{printf("\%d \%d \%d\n", 42, 23, 42);}  \hfill \fillin[\CD{42 23 42}][5cm]
...
\begin{parts}
  \part \CD{r = sscanf("42", "\%d", &i);} \hfill \fillin[i = 42, r = 1][8cm]
  \part \CD{r = sscanf("4 8", "\%d", &i);} \hfill \fillin[i = 4, r = 1][8cm]
