...
long x = 100;
if (x = 0) 
    print("Erreur : la valeur 0 est interdite !\n");
\end{lstlisting}
...
Écrire une fonction qui reçoit en paramètre un tableau d'entiers et qui retourne la position de la première occurrence d'une valeur dans ce tableau, ou \CD{-1} si la valeur n'est pas présente. Utiliser la syntaxe pointeur pour le paramètre tableau. 
