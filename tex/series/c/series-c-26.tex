...
\question
On souhaite lire un fichier dont la taille n'est pas connue avant l'exécution du programme. Un espace mémoire doit alors être réservé sur le \emph{heap}. Écrire la fonction \cinline!load! permettant de charger l'ensemble du fichier en mémoire dans la variable \cinline!data!.
...
\part Déclarez la variable \cinline!r! puis allouer l'espace mémoire nécessaire pour y stocker 10 points.
\begin{solution}
\begin{code}[c]
...
\part Redimensionnez la variable \cinline!r! pour y stocker jusqu'à 100 points.
\begin{solution}
\begin{code}[c]
...
\question Une fonction s'occupe de redimensionner un set de données pour pouvoir y stocker \cinline!n! valeurs. Écrire la fonction \cinline!resize!.
...
La grille est stockée dans un pointeur sur un tableau à deux dimensions, dont chaque dimension est la taille de la variable \cinline!columns!.
