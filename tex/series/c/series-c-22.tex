...
\end{solution}
\fi
\part Déclarez un tableau de \cinline{Birthday} de taille \cinline{10}. Initialisez la première entrée avec le nom \texttt{John Doe} et la date \texttt{2000-01-01}.
...
\begin{parts}
    \part \cinline{struct { int32_t a; int32_t b; };}
    \fillin[8 bytes]
    \part \cinline{struct { char *name; int32_t age; };}
    \fillin[12 bytes sur une machine 64 bits]
    \part \cinline{struct { char k[8]; short s[2]; };}
    \fillin[12 bytes]
    \part \cinline{struct { char a; short b; };}
