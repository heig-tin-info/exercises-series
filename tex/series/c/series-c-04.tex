...
Dans les cas où elles sont fausses, expliquer ce qui serait correct pour une instruction \cinline{do..while} :
\begin{parts}
...
\part Les instructions de la boucle ne peuvent pas être une autre boucle \cinline{do..while}.

\ifprintanswers
\begin{solution}
Incorrect. Une boucle do while peut se trouver à l'intérieur d'une boucle \cinline{do..while}.
\end{solution}
\else
\fillwithdottedlines{1cm}
\fi
...
\question
\begin{parts}
\part Écrire un programme qui affiche les nombres entiers de 1 à 100 en employant une boucle \cinline{for}.
...
\part Écrire ce même programme en utilisant une boucle \cinline{while}
...
\part Même question avec une boucle \cinline{do..while}
...
\ifprintanswers
\begin{solution}
Lorsque le nombre d'itérations est connu à l'avance, la boucle \cinline{for} est la plus adaptée.
\end{solution}
\else
...
\clearpage
\question Boucles \cinline{for} : renseignez ce qu'affiche ces boucles.
\begin{parts}
\part
\begin{lstlisting}
...
\clearpage
\question Boucles \cinline{while} : renseignez ce qu'affiche ces boucles.
\begin{parts}
\part
\begin{lstlisting}
int i = 0;
