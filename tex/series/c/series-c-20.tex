...
\textbf{Exemple :} \cinline{2 / 3 * c}, réponse : \cinline{(int)0}.

\begin{parts}
    \part \cinline{c / 2}
    \answerline[\canswer{(int)1}]

    \part \cinline{s + c / 10}
    \answerline[\canswer{(int)7}]

    \part \cinline{l + i / 2.0}
    \answerline[\canswer{(double)5.5}]

    \part \cinline{d + f}
    \answerline[\canswer{(double)11}]

    \part \cinline{(int)d + f}
    \answerline[\canswer{(float)10.3}]

    \part \cinline{(int)d + l}
    \answerline[\canswer{(long)11}]

    \part \cinline{c << 2}
    \answerline[\canswer{(int)12}]

    \part \cinline{s & 0xf0}
    \answerline[\canswer{(int)0}]

    \part \cinline{s && 0xf0}
    \answerline[\canswer{(int)1}]

    \part \cinline{d + f == s + l}
    \answerline[\canswer{(int)0}]
\end{parts}
...
Il manque les accolades autour du bloc \cinline{do..while}.
...
\begin{solutionordottedlines}[2cm]
Le test d'égalité utilise l'opérateur \cinline{==}. L'opérateur d'affectation \cinline{=} n'est pas valable.
\end{solutionordottedlines}
...
\begin{solutionordottedlines}[2cm]
L'instruction \cinline{switch} n'est pas applicable à un type à virgule flottante.
\end{solutionordottedlines}
...
\begin{solutionordottedlines}[2cm]
Il manque des parenthèses autour de la condition de l'instruction \cinline{while}.
\end{solutionordottedlines}
\end{parts}
...
\cinline{00000 105 102 300 102}
\end{solutionordottedlines}

\question Algorithme sur les tableaux : écrire une fonction qui reçoit en paramètre un tableau d'entiers et qui retourne la position de la première occurrence d'une valeur dans ce tableau, ou \cinline{-1} si la valeur n'est pas présente. Utiliser la syntaxe pointeur pour le paramètre tableau.
