...
\part Représentez par un arbre les appels de fonction imbriqués lors de l'évaluation pour l'appel de \cinline!fib(7)!.
...
\begin{solution}
Pour l'appel de \cinline!fib(7)! on peut voir le nombre d'appels suivants.
