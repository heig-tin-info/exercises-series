...
Utilisez ici \cinline{assert} pour le test des erreurs, et ne réduisez pas la taille du tableau, il ne fait que s'agrandir au gré des données le peuplant.
\begin{questions}
...
\part Écrire une structure de donnée représentant un tableau dynamique et permettant de stocker des paires de \cinline{double}.
\ifprintanswers
\begin{solution}
\begin{lstlisting}
...
\part Écrire la fonction \cinline{array_init}
...
\part Écrire la fonction \cinline{array_push}
...
\part Écrire la fonction \cinline{array_pop}
...
\part Écrire la fonction \cinline{array_shift}
...
\part Écrire la fonction \cinline{array_unshift}
...
\part Écrire la fonction \cinline{array_insert}
...
\part Écrire la fonction \cinline{array_delete}
