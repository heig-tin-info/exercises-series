...
\begin{multicols}{2}
    \begin{questions}
        ...
        Écrire un programme \cinline!brake.c! qui lit \textbf{sept arguments} en \cinline!int! ou \cinline!double! depuis la ligne de commande, donnés dans des unités volontairement peu pratiques. On suggère d'utiliser un suffixe dans le nom des variables pour rappeler l'unité, par exemple \cinline!v0\_kmh! pour la vitesse initiale en km/h. Les arguments sont :

        \begin{enumerate}
            \item \cinline!v0\_kmh! : vitesse initiale en \si{\kilo\metre\per\hour};
            \item \cinline!m\_t! : masse du véhicule en tonnes;
            \item \cinline!mu\_permille! : coeff. de frottement en \si{\perthousand};
            \item \cinline!A\_dm2! : surface frontale en \si{\deci\metre\squared};
            \item \cinline!Cd! : coefficient de traînée (sans dimension);
            \item \cinline!rho\_gL! : densité de l'air en g/L (indice : \SI{1}{\gram\per\litre} = \SI{1}{\kilogram\per\metre\cubed});
            \item \cinline!g\_Gal! : accélération gravitationnelle en Gal (\SI{1}{Gal} = \SI{0.01}{\metre\per\second\squared}).
        \end{enumerate}
...
Distance d'arrêt : 82.881 m
        ...
        \begin{enumerate}
            ...
            \item Écrire un squelette de programme avec les inclusions nécessaires et la fonction \cinline!main!.
