...
La fonction \CD{strlen} itère sur la chaîne de caractères jusqu'à trouver la sentinelle \CD{'\textbackslash 0'}.
\end{solutionordottedlines}
...
\part Comment modifier le prototype de `f` pour que le tableau puisse être parcouru mais qu'il ne puisse pas être modifié ?
